...
@section('content')
<a type="button" class="btn btn-outline-primary" href="{{route('teacher.create')}}">Create</a>
 <h1 class="text-primary text-center">teacher list</h1>
...
<table class="table table-striped table-hover">
    ...
    <tr>
      ...
      <td>    <a class="btn btn-sm btn-warning" href="{{ route('teacher.edit', $teacher->id) }}">Edit</a>
